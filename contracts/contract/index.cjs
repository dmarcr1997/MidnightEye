...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      addImage: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`addImage: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const hash_0 = args_1[1];
        const owner_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('addImage',
                                      'argument 1 (as invoked from Typescript)',
                                      'image-management.compact line 10 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(hash_0).concat(_descriptor_0.toValue(owner_0)),
        ...
        const result_0 = this._addImage_0(context,
                                          partialProofData,
                                          hash_0,
                                          owner_0);
      ...
      grantAccess: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`grantAccess: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const hash_0 = args_1[1];
        const owner_0 = args_1[2];
        const newUser_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('grantAccess',
                                      'argument 1 (as invoked from Typescript)',
                                      'image-management.compact line 16 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        if (!(hash_0.buffer instanceof ArrayBuffer && hash_0.BYTES_PER_ELEMENT === 1 && hash_0.length === 32)) {
        ...
        if (!(newUser_0.buffer instanceof ArrayBuffer && newUser_0.BYTES_PER_ELEMENT === 1 && newUser_0.length === 32)) {
          __compactRuntime.type_error('grantAccess',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(hash_0).concat(_descriptor_0.toValue(owner_0).concat(_descriptor_0.toValue(newUser_0))),
    ...
    this.impureCircuits = {
      addImage: this.circuits.addImage,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('addImage', new __compactRuntime.ContractOperation());
  ...
  _addImage_0(context, partialProofData, hash_0, owner_0) {
    Contract._query(context,
                    partialProofData,
                    [
                     { idx: { cached: false,
                              ...
                              path: [
                                     { tag: 'value',
                                       value: { value: _descriptor_4.toValue(1n),
                                                alignment: _descriptor_4.alignment() } },
                                     { tag: 'value',
                                       value: { value: _descriptor_0.toValue(hash_0),
  ...
  _grantAccess_0(context, partialProofData, hash_0, owner_0, newUser_0) {
                              ...
                              path: [
                                     ...
                                     { tag: 'value',
                                       value: { value: _descriptor_0.toValue(hash_0),
                                                alignment: _descriptor_0.alignment() } }] } },
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(newUser_0),
                                                                            alignment: _descriptor_0.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newNull().encode() } },
                     { ins: { cached: false, n: 1 } },
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'image-management.compact line 4 char 1',
                                      'Bytes<32>',
                                      elem_0)
        }
        return _descriptor_2.fromValue(Contract._query(context,
    ...
    access: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'image-management.compact line 5 char 1',
                                      'Bytes<32>',
                                      key_0)
        }
        return _descriptor_2.fromValue(Contract._query(context,
        ...
        return {
          ...
          member(...args_1) {
            ...
            if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
              __compactRuntime.type_error('member',
                                          'argument 1',
                                          'image-management.compact line 5 char 38',
                                          'Bytes<32>',
                                          elem_0)
            }
            return _descriptor_2.fromValue(Contract._query(context,
